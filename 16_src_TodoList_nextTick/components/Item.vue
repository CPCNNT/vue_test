<template>
  <li>
    <label>
      ...
      <input type="text" v-show="todo.isBeingEdited" v-bind:value="todo.title" v-on:blur="handleBlur(todo, $event)" ref="editTitle">
    </label>
    <div class="btns">
      <button class="btn btn-edit" v-on:click="handleEdit(todo)" v-show="!todo.isBeingEdited">编辑</button>
